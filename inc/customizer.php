...
function kava_get_customizer_options(): array {
	 ...
	 * @since 1.0.0
	 */
	return apply_filters( 'kava-theme/customizer/options' , [
		'prefix'        => 'kava',
